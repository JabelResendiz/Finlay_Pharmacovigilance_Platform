...
public class MockMunicipalDashboardService : IMunicipalDashboardService
{
    private readonly IUnitOfWork _unitOfWork;
    private readonly ILogger<MockMunicipalDashboardService> _logger;
    ...
    public MockMunicipalDashboardService(
        IUnitOfWork unitOfWork,
        ILogger<MockMunicipalDashboardService> logger,
    ...
    public async Task<SectionResponsibleMunicipalDashboardDto> GetDashboardAsync(DashboardFilterDto filter)
    {
            ...
            SeverityDistribution = new List<SeverityDistributionDto>
        {
            ...
            TotalDeaths = 5,
            TotalVisitedDoctor = 10,
            TotalEmergencyRoom = 32,
            TotalWasHospitalized = 20,
            TotalAnomaly = 3,
            TotalPermanentDisability = 2,
            TotalNoComplications = 1
        };
    }
